...
Slack.create_channel = name => {
  ...
  return axios
    .post("https://slack.com/api/channels.create", querystring.stringify(data))
    .then(response => {
...
Slack.get_channel_id = (name, cursor) => {
  ...
  return axios
    .get(
      `https://slack.com/api/conversations.list?${querystring.stringify(data)}`
    )
    .then(response => {
...
Slack.message = (channelId, text, attachments) => {
  ...
  return axios
    .post("https://slack.com/api/chat.postMessage", querystring.stringify(data))
    .then(response => {
      logger.info(response.data);
    })
    .catch(err => {
...
Slack.command = (channelId, command, text) => {
  ...
  return axios
    .post("https://slack.com/api/chat.command", querystring.stringify(data))
    .then(response => {
      logger.info(response.data);
    })
    .catch(err => {
...
Slack.archive = channelId => {
  ...
  return axios
    .post("https://slack.com/api/channels.archive", querystring.stringify(data))
    .then(response => {
      logger.info(response.data);
    })
    .catch(err => {
