...
" at 11:30`);
  ...
  // Lunch
  Slack.command(channelId, '/poll', '"昼食どこらへんが好き？(種別: 店名(目安金額))" "イタリアン: タンタボッカ(1100円)" "天丼: 高瀬(1500円)" "寿司: 高瀬(1300円)" "インドカレー: アヒリヤ(1000円)" "カレー: 野菜を食べるカレーcamp(1000円)" "中華: 代々木餃子(800円)" "和食: おひつ膳(1200円)" "肉: 土古里(1000円)" "オフィスにいます"');
